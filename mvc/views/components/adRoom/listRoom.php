...
<script>
  function html_table_to_excel(type) {
    ...
    XLSX.writeFile(file, 'ListRoom.' + type);
  }
</script>
<div class="content-wrapper" style="min-height: 1203.6px;">
  ...
  <div class="creat-acc">
    <a href="/qlkhachsan/adRoom/addRoom" class="btn-add">Thêm</a>
    <form action="/qlkhachsan/adRoom/search" method="post">
      <input type="text" name="namekey" placeholder="Nhập mã phòng ...">
                ...
                <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                  <thead>
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">ID Room</th>
                      ...
                      <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Tên phòng</th>
                      ...
                      <tr role="row" class="odd">
                        ...
                        <td style="text-align: center;">
                          <span class="badge bg-primary">
                            <a href="/qlkhachsan/adRoom/update/<?php echo $row['idRoom'] ?>">
                        ...
                        <td style="text-align: center;">
                          <span class="badge bg-danger">
                            <a href="/qlkhachsan/adRoom/delete/<?php echo $row['idRoom'] ?>">
