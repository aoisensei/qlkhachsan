              ...
              <div class="col-sm-12">
                <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                  ...
                  <tbody>
                    <?php
                    $i = 1;
                    foreach ($data['listSearchRoom'] as $value) { ?>
                      <tr role="row" class="odd">
                        <td class="sorting_1"><?php echo $i++; ?></td>
                        <td><?php echo $value["idRoom"]; ?></td>
                        <td><?php echo $value["typeRoom"]; ?></td>
                        <td><?php echo $value["nameRoom"]; ?></td>
                        <td><?php echo $value["priceRoom"]; ?></td>
                        <td><?php echo $value["amount"]; ?></td>
                        <td style="text-align: center;">
                          <span class="badge bg-primary">
                            <a href="/qlkhachsan/adRoom/update/<?php echo $value['idRoom'] ?>">
                        ...
                        <td style="text-align: center;">
                          <span class="badge bg-danger">
                            <a href="/qlkhachsan/adRoom/delete/<?php echo $value['idRoom'] ?>">
